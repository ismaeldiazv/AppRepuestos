...
'Corriente Max A': 'Corriente Max A',
...
'Enter a valid email address': 'Eso no es un correo electrónico',
'enter a value': 'introduzca un valor',
'Enter a value': 'Campo Obligatorio de Rellenar',
'Enter an integer between %(min)g and %(max)g': 'Introduce Valor Numérico',
...
'Enter date as %(format)s': 'Escriba la fecha como %(format)s',
...
'Fecha de préstamo': 'Fecha de préstamo',
'file': 'Archivo PDF',
...
'Libro': 'Libro',
'Libro sólo para adultos': 'Libro sólo para adultos',
...
'Medida': 'Medida',
'Medida Capacidad': 'Medida Capacidad',
'Medida Resistencia': 'Medida Resistencia',
...
'not in': 'no en',
'Numero Patillas': 'Numero Patillas',
...
'Tension Max V': 'Tension Max V',
'Tension Maxima': 'Tension Maxima',
'Tension Maxima (V)': 'Tension Maxima (V)',
'Tensión Maxima (V)': 'Tensión Maxima (V)',
'test': 'probar',
...
'Unidad Frecuencia': 'Unidad Frecuencia',
'Unidad Inductancia': 'Unidad Inductancia',
'Unidad Medida': 'Unidad Medida',
'Unidad Resistenc': 'Unidad Resistenc',
...
'Value not in database': 'Introduce Valor Predeterminado',
